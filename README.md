...
**非常感谢您愿意给我这样一次机会。因为我现在简历里还没有特别拿得出手的 AI 项目经历，所以我很珍惜这次展示自己的机会。所以对我来说，这不只是做一个朋友圈的题，而是一次让我用实际结果去证明自己学习能力、快速落地、工程思考方式，还有 AI 实际使用能力的机会。由于我晚上7点才能到达学校，所以我在面试当天晚上10点半进行了部分开发工作，主要是完成了整体的架构、规范说明、开发边界、数据模型等，快速实现了v1版本。在完成v1版本之后考虑到更多线上可能存在的问题，从真实场景进行考量，加入了降级策略、高并发下稳定性、延迟优化等。这个过程里我也尽量不让自己停留在“把功能做出来”这一步，而是不断去想清楚边界、约束、性能和真实场景下可能遇到的问题。最后很感谢您愿意给我这个证明自己的机会，我自己其实也很希望能有机会加入币安，在更高要求的环境里继续学习和成长。**
